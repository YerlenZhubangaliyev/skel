...
DIR_APP_STATIC_LC="${DIR_STATIC}/${APP,,}"
DIR_APP_SRC_DIR="${DIR_APP_STATIC}/src"
DIR_APP_SRC_DIR_LC="${DIR_APP_STATIC_LC}/src"
DIR_APP_LOCALE="${DIR_LOCALE}/${APP,,}/${MOD,,}"
DIR_APP_LOCALE_RES="${DIR_LOCALE}/${APP,,}/${MOD,,}/res"
DIR_APP_LOCALE_SRC="${DIR_LOCALE}/${APP,,}/${MOD,,}/src/txt"
